...
```{r}
#| echo: false
packages <- c("readr", "dplyr", "DescTools", "moments", "vtable", "skimr", "summarytools", "knitr")
```
...
a.  Calcular el número medio de medicamentos que toman las personas de la muestra e interpretarlo.
...
a.  Calcular la mediana e interpretarla.
...
a.  Calcular la moda e interpretarla.
...
a.  Calcular los cuartiles e interpretarlos.
...
a.  Calcular los percentiles 5 y 95 e interpretarlos.
