...
\item
  ...
  \begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, toptitle=1mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, colback=white, left=2mm, bottomtitle=1mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, toprule=.15mm, coltitle=black]
